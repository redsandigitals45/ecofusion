...
const ReviewCard = ({ review }) => (
    <div className="r-card">
        ...
        <div className="r-card-quote-bg">“</div>
    </div>
);
        ...
        <div className="reviews-page">
            ...
            <div className="r-breadcrumb-bar">
                <div className="container">
                    <span className="r-icon">⌂</span> <Link to="/">Home</Link> <span className="r-sep">›</span> <strong>Reviews</strong>
                </div>
            </div>
            ...
            <section className="r-hero">
                <div className="container text-center">
                    <Link to="/" className="r-back-link">‹ BACK TO HOME</Link>
                    <div className="r-badge">CANDIDATE TESTIMONIALS</div>
            ...
            <section className="r-big-cta">
                ...
                <div className="r-cta-content container text-center">
                    ...
                    <div className="r-cta-actions">
                        <Link to="/careers" className="btn btn-primary">BROWSE ACTIVE JOBS ➔</Link>
