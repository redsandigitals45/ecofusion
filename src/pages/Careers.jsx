                    ...
                    <div className="c-categories-grid">
                        <div className="c-cat-card">
                            <div className="c-cat-img-wrapper">
                                ...
                                <div className="c-cat-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 10v6M2 10l10-5 10 5-10 5-10-5Z" /><path d="M6 12v5c0 1.7 2.7 3 6 3s6-1.3 6-3v-5" /></svg></div>
                            </div>
                        ...
                        <div className="c-cat-card">
                            <div className="c-cat-img-wrapper">
                                ...
                                <div className="c-cat-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M2 16l20-8-8 20-3-9-9-3Z" /></svg></div>
                            </div>
                            <div className="c-cat-content">
