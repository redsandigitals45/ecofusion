                    ...
                    <div className="c-categories-grid">
                        <div className="c-cat-card">
                            <div className="c-cat-img-wrapper">
                                <img src="/assets/img/careerspage/full-shot-couple-traveling-together.jpg" alt="Cruise" />
                        ...
                        <div className="c-cat-card">
                            <div className="c-cat-img-wrapper">
                                <img src="/assets/img/careerspage/pilot-air-hostess-walking-with-their-trolley-bags.jpg" alt="Aviation" />
                        ...
                        <div className="c-cat-card">
                            <div className="c-cat-img-wrapper">
                                <img src="/assets/img/careerspage/professional-driver-sitting-cockpit-operating-high-speed-train.jpg" alt="Merchant Navy" />
                        ...
                        <div className="c-cat-card">
                            <div className="c-cat-img-wrapper">
                                <img src="/assets/img/careerspage/portrait-male-security-guard-with-uniform.jpg" alt="Security" />
