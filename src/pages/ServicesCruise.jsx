                ...
                <div className="sc-container">
                    ...
                    <div className="sc-elig-grid">
                        ...
                        <div className="sc-elig-card">
                            ...
                            <h4 className="sc-elig-title">Certifications</h4>
                            <div className="sc-elig-subtitle">STCW & Other Certifications</div>
                            <p className="sc-elig-desc">STCW and other certifications required for cruise ship careers.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="sc-container sc-earn-grid">
                    <div>
                        ...
                        <div className="sc-salary-card">
                            ...
                            <div className="sc-salary-amount">$1,200 - $4,000 / Month</div>
                    ...
                    <div className="sc-related-grid">
                        <div className="sc-related-card">
                            <div className="sc-related-img">
                                ...
                                <img src="https://images.unsplash.com/photo-1544644181-1484b3fdfc62?auto=format&fit=crop&w=600&q=80" alt="Air Hostess" />
                            </div>
